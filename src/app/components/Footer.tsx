      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-sm text-gray-500 max-w-xl">
            ...
            comprehensive visual guides and examples. Learn responsive layouts,
            modern design patterns, and simplified workflows - all with
            Tailwind&apos;s intuitive utility classes.
          </p>
