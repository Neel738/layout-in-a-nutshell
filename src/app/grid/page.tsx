...
export default function GridPage() {
  ...
  const sections = [
    ...
    { id: "spanning", title: "Column & Row Spanning" },
    { id: "custom-grid", title: "Custom Grid Templates" },
    { id: "grid-auto-flow", title: "Grid Auto Flow" },
    { id: "grid-alignment", title: "Grid Alignment" },
    { id: "responsive-grid", title: "Responsive Grid" },
    { id: "common-layouts", title: "Common Layouts" },
  ];
    ...
    <div className="flex flex-col lg:flex-row gap-8">
      ...
      <div className="flex-1 space-y-12">
        ...
        <div className="space-y-16">
          ...
          >
            <div id="basic-grid" className="scroll-mt-24"></div>
            <SubSection
  ...
  <div>Item 4</div>
          ...
          >
            <div id="grid-gap" className="scroll-mt-24"></div>
            <SubSection
              ...
              highlightedParts={[
                {
                  text: "gap-4",
                  explanation:
                    "Adds 1rem (16px) of space between all grid items",
                },
              ]}
            >
  ...
  <!-- More items -->
              ...
              highlightedParts={[
                ...
                },
                {
                  text: "gap-y-2",
                  explanation:
                    "Adds 0.5rem (8px) of vertical space between rows",
                },
              ]}
            >
          ...
          >
            <div id="spanning" className="scroll-mt-24"></div>
            <SubSection
  ...
  <!-- More items -->
          ...
          >
            <div id="custom-grid" className="scroll-mt-24"></div>
            <SubSection
  ...
  <div>Fixed 100px height footer</div>
          ...
          >
            <div id="grid-auto-flow" className="scroll-mt-24"></div>
            <SubSection
  ...
  <div>Item</div>
          ...
          >
            <div id="grid-alignment" className="scroll-mt-24"></div>
            <SubSection
              ...
              highlightedParts={[
                {
                  ...
                  explanation:
                    "Aligns grid items to the left side of their cell",
                },
                {
...
<div className="grid grid-cols-2 items-center h-32">
  ...
  <!-- More items -->
          ...
          >
            <div id="responsive-grid" className="scroll-mt-24"></div>
            <SubSection
  ...
  <div className="col-span-3 md:col-span-6">Item D</div>
          ...
          >
            <div id="common-layouts" className="scroll-mt-24"></div>
            <SubSection
              title="Holy Grail Layout"
              description="A classic web layout with header, footer, main content, and sidebars."
              code={`<div className="grid grid-cols-1 md:grid-cols-[100px_1fr_100px] grid-rows-[auto_1fr_auto] min-h-screen">
              ...
              highlightedParts={[
                {
                  ...
                  explanation:
                    "Three-column layout on desktop with fixed sidebars and flexible middle",
                },
                {
                  text: "grid-rows-[auto_1fr_auto]",
                  explanation:
                    "Three rows: auto-sized header, flexible content area, auto-sized footer",
                },
                {
                  text: "col-span-full",
                  explanation:
                    "Makes header and footer span across all columns",
                },
              ]}
            >
              <div className="grid grid-cols-1 md:grid-cols-[100px_1fr_100px] grid-rows-[auto_1fr_auto] gap-2 h-96 w-full">
                <div className="col-span-full bg-purple-100 dark:bg-purple-900/30 p-4 rounded-t flex items-center justify-center font-semibold">
                  Header
                </div>
                <div className="bg-purple-100 dark:bg-purple-900/30 p-4 rounded flex items-center justify-center font-semibold md:h-full">
                  Sidebar
                </div>
                <div className="bg-gradient-to-br from-purple-300 to-indigo-300 dark:from-purple-800/40 dark:to-indigo-800/40 p-4 rounded flex items-center justify-center font-semibold md:h-full">
                  Main Content
                </div>
                <div className="bg-purple-100 dark:bg-purple-900/30 p-4 rounded flex items-center justify-center font-semibold md:h-full">
                  Aside
                </div>
                <div className="col-span-full bg-purple-100 dark:bg-purple-900/30 p-4 rounded-b flex items-center justify-center font-semibold">
                  Footer
                </div>
              </div>
            </SubSection>
  ...
  <!-- More images -->
              ...
              highlightedParts={[
                {
                  text: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4",
                  explanation:
